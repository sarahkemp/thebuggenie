        ...
        public static function getAvailableViews($target_type)
        {
            ...
            switch ($target_type)
            {
                ...
                case self::TYPE_PROJECT:
                    ...
                    $searches['statistics'][self::VIEW_PROJECT_STATISTICS_LAST15] = array(0 => array('title' => $i18n->__('Graph of closed vs open issues'), 'description' => $i18n->__('Shows a line graph comparing closed vs open issues for the past 30 days')));
